...
fetch("https://api.coronatracker.com/news/trending?limit=25&offset&country="+json.country+"&countryCode", requestOptions)
  ...
  .then(result => (function(){
        ...
        for(i = 0; i < 25 ; i++){
          document.getElementById("news1").innerHTML += "<li class=''><span>" + result.items[i].publishedAt.replace("T"," ").replace("Z"," ") + "</span><br><a href='" + result.items[i].url + "'>" + result.items[i].title + "</a></li>";
        }
